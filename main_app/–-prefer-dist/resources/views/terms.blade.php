...
<!-- 
		...
		<div class="container">
			<div class="row">
				<div class="offset-lg-3 col-lg-6">
					...
					<p class="text-center m-b-40">Fusce placerat pretium mauris, vel sollicitudin elit lacinia vitae. Quisque sit amet nisi erat.</p>
					<div class="input-buttons primary gradient">
	...
	<!-- jQuery -->
	<script src="{{URL::asset('eir-assets/js/jquery-2.1.0.min.js '); }}"></script>
	
	<!-- Bootstrap -->
	<script src="{{URL::asset('eir-assets/js/popper.js'); }}"></script>
	<script src="{{URL::asset('eir-assets/js/bootstrap.min.j'); }}"></script>

	<!-- Plugins -->
	<script src="{{URL::asset('eir-assets/js/scrollreveal.min.js'); }}"></script>
	<script src="{{URL::asset('eir-assets/js/imgfix.min.js'); }}"></script>
	<script src="{{URL::asset('eir-assets/js/owl.carousel.min.js '); }}"></script>
	<script src="{{URL::asset('eir-assets/js/parallax.min.js'); }}"></script>
	<script src="{{URL::asset('eir-assets/js/waypoints.min.js'); }}"></script>
	<script src="{{URL::asset('eir-assets/js/jquery.counterup.min.js'); }}"></script>
	<script src="{{URL::asset('eir-assets/js/stickySidebar.js'); }}"></script>
	
	<!-- Global Init -->
	<script src="{{URL::asset('eir-assets/js/global.js'); }}"></script>
</body>
</html>